      ...
      {value ? (
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            <span className="ml-auto truncate font-mono text-[10px] text-slate-500" title={value}>
              {value.startsWith("db:")
        ...
        <>
          ...
          >
            {isUploading ? (
              ...
              <>
                ...
                <span className="text-[11px] text-slate-500">Otimizada para WebP automaticamente</span>
              </>
            )}
          </button>
          ...
          <div className="flex items-center gap-3 text-[11px]">
            ...
            <button
              ...
              className="flex items-center gap-1 text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"
            >
