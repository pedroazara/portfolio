            ...
            <div className="max-h-[88vh] overflow-y-auto">
              ...
              <div className="p-6 sm:p-10 lg:p-14">
                <div className="max-w-4xl mx-auto">
                  ...
                  {displayDescription && (
                    <div className="mb-8 rounded-2xl bg-indigo-50/70 dark:bg-indigo-950/40 p-5 sm:p-6 border-l-4 border-indigo-600 dark:border-indigo-500 shadow-xs w-full">
                  ...
                  <div className="mb-10 space-y-6">
                    ...
                    <div className="prose prose-indigo dark:prose-invert max-w-none w-full text-slate-800 dark:text-slate-200 text-base sm:text-lg leading-relaxed">
                  ...
                  {displayScientificRelevance && (
                    <div className="mb-10 rounded-2xl bg-slate-50 dark:bg-slate-800/60 p-6 sm:p-8 border border-indigo-100 dark:border-indigo-950/80 shadow-xs space-y-3 w-full">
